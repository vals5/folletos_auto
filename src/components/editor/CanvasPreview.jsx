...
const IMPREC = {
  ...
  productName: {
    fontFamily: "'Imprec-Name',sans-serif",
    fontSize: "9pt",
    lineHeight: 1.05,
    textTransform: "uppercase",
    color: "#000000",
  ...
  productDesc: {
    fontFamily: "'Imprec-Desc',sans-serif",
    fontSize: "7pt",
    lineHeight: 1.05,
    textTransform: "uppercase",
    color: "#555555",
...
const TAMANO_SIZE = {
  XS: { width: 90, height: 100 },
  S: { width: 130, height: 120 },
  M: { width: 185, height: 140 },
  L: { width: 250, height: 160 },
  XL: { width: 350, height: 185 },
};

const TIPO_PRECIO_LABEL = {
  regular: null,
  llevando3: "LLEVANDO 2",
...
const BORDER_STYLES = {
  none: "none",
  solid: "2px solid #ff0000",
  dashed: "2px dashed #ff0000",
  thick: "3px solid #ff0000",
};
...
export default function CanvasPreview({
  ...
  return (
    ...
    >
        ...
        <Box display="flex" alignItems="center" gap={2}>
          ...
          >
            ...
            <Slider
              ...
              size="small"
              sx={{ flex: 1, color: "white", "& .MuiSlider-thumb": { width: 14, height: 14 } }}
            />
            ...
            <Typography fontSize={11} color="white" sx={{ minWidth: 32, textAlign: "right" }}>
              {zoom}%
            </Typography>
          </Box>
      ...
      >
        <Box
          sx={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", overflow: "visible" }}
        >
          <Box
            sx={{
            ...
            {paginas.length === 0 ? (
              <Box bgcolor="white" p={4} borderRadius="8px" textAlign="center" boxShadow="0 2px 10px rgba(0,0,0,0.05)">
                <Typography color="textSecondary" fontSize={14}>
                  No hay páginas en este folleto.
                </Typography>
              </Box>
            ) : (
              paginas.filter(Boolean).map((pag, idx) => {
                ...
                return (
                  <PaginaCanvas
                    ...
                    canvasRef={(el) => {
                      canvasRefs.current[idx] = { current: el };
                    }}
